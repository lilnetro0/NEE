...
export const Route = createFileRoute("/legal/refunds")({ component: () => (
  <LegalDoc title="Refund Policy">
    ...
    <H2>Process</H2>
    <p>Contact support with your order ID. Refunds go to the original payment method within 3–7 business days.</p>
  </LegalDoc>
)});
